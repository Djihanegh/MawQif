    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        User user = new User(
            ...
            codePersonnel: Uuid.NAMESPACE_DNS );
        addUser(user);
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'Choisir une addresse email valide ';
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errorMessage = 'Ce password est faible.';
      ...
      const errorMessage =
          'Erreur dauthentification, veuillez réessayer plus tard.';
      _showErrorDialog(errorMessage);
    }
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                          ...
                          validator: (value) {
                            if (value.length < 6) {
                              return 'Le mot doit au moins avoir 6 char';
                            }
                          },
                          onSaved: (value) {
